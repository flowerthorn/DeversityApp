...
import com.lhx.diversityapp.utils.AppUtils;
...
//            }
            ...
            dialog.addContentView(view, new LayoutParams(ViewUtils.getScreenWidth(context) - ViewUtils.dip2px(context, 70), LayoutParams.WRAP_CONTENT));
